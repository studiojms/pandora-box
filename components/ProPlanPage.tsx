  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4 animate-fade-in">
      ...
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">{t.proPlanDesc}</p>
        ...
        <div className="flex items-center justify-center gap-4 pt-8">
          ...
          >
            <div
              className={`w-4 h-4 bg-purple-500 rounded-full transition-all ${billingCycle === 'YEARLY' ? 'ml-6' : 'ml-0'}`}
            ></div>
          </button>
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FeatureCard
              ...
              desc="Internal ideas remain visible only to your verified employees."
            />
            <FeatureCard
              icon={<Users className="text-cyan-400" />}
              title="Team Collaboration"
              desc="Group contributors into departments for targeted brainstorming."
            />
            <FeatureCard
              icon={<BarChart3 className="text-emerald-400" />}
              title="Advanced Analytics"
              desc="Track innovation velocity and engagement across departments."
            />
            <FeatureCard
              icon={<Rocket className="text-rose-400" />}
              title="Branded Content"
              desc="Public ideas carry your company's identity and legacy."
            />
          </div>
